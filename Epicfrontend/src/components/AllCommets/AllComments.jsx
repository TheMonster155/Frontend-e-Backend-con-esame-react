...
const AllComments = ({ _id }) => {
    ...
    const addOrUpdateComment = async (e) => {
        ...
        const userId = decodedToken ? decodedToken._id : '' // Estrai l'ID utente dal token
            ...
            try {
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        ...
                        user: userId, // Usa l'ID utente decodificato
            ...
            try {
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        rate: modalFormState.rate,
                        comment: modalFormState.comment,
                        user: currentUserId, // Usa l'ID utente decodificato
                        book: modalFormState.book,
                    }),
                })
